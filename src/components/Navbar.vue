    ...
    <div class="flex flex-col items-center justify-center py-4">
        ...
        <div class="flex flex-row w-full justify-evenly m-1 p-1">
            <div class="flex justify-center items-center w-full h-16 sm:h-16"> 
                <button class="text-[15px] sm:text-xl cursor-pointer hover:text-blue-400">
                    <a href="/">
            ...
            <div v-if="!authStore.isAuthenticated "class="flex items-center justify-center w-full">
                <form :action="`${backendUrl}/auth/oauth`">
                    <button class="text-[15px] sm:text-xl cursor-pointer hover:text-blue-400">Log in</button>
                </form>
            </div>
            ...
            <div v-if="authStore.isAuthenticated" class="flex items-center justify-center w-full">
                <button class="text-[15px] sm:text-xl cursor-pointer hover:text-blue-400"><a href="/bucket">My Bucket</a></button>
            </div>

            <div v-if="authStore.isAuthenticated" class="flex items-center justify-center w-full">
                <button class="text-[15px] sm:text-xl cursor-pointer hover:text-blue-400"><a href="/">Share Files</a></button>
            </div>
